...
interface generator_serviceIf {
  public function gen_id();
}

class generator_serviceClient implements generator_serviceIf {
  ...
  public function recv_gen_id()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\generator_service_gen_id_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
...
class generator_service_gen_id_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'generator_service_gen_id_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('generator_service_gen_id_args');
...
class generator_service_gen_id_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'generator_service_gen_id_result';
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      {
        case 0:
          if ($ftype == Thrift\Type\TType::I64) {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('generator_service_gen_id_result');
    if ($this->success !== null) {
      $xfer += $output->writeFieldBegin('success', Thrift\Type\TType::I64, 0);
